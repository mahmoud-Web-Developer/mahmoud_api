...
Write-Host "   رفع التغييرات بعد إنشاء مجلد الـ APIs" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
...
try {
    $commitResult = & git commit -m "feat: إنشاء مجلد apis/ وتنظيم ملفات الـ APIs" 2>&1
    if ($LASTEXITCODE -eq 0) {
...
Write-Host "✅ تم إنشاء مجلد apis/ بنجاح" -ForegroundColor Green
Write-Host "✅ جميع ملفات الـ APIs منظمة" -ForegroundColor Green
